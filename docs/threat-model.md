...
**Remaining limitation:** unrelated invalid JSON that cannot be recognized as a `tools/call` attempt is still forwarded unchanged. This is not universal malformed-JSON protection.
