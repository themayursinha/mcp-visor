...
|-------|------|---------|-------------|
| `max_argument_size_bytes` | int | 1048576 | Max tool call argument size (1 MB). Measured on the client `arguments` bytes before unique-key collapse. Larger calls rejected. |
